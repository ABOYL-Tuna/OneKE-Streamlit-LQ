...
# ==================== OneKE 路径配置 ====================
ONEKE_CONFIG = {
    "source_path": Path("../OneKE/src"),
    "data_path": Path("../OneKE/data"),
    "input_files_path": Path("../OneKE/data/input_files")
}
...
# ==================== 示例数据配置 ====================
EXAMPLES_CONFIG = {
    "chinese_news_file": "../OneKE/data/input_files/ChineseNewsExample.json",
    "example_files": {
        "ai_wikipedia": "../OneKE/data/input_files/Artificial_Intelligence_Wikipedia.txt",
        "harry_potter": "../OneKE/data/input_files/Harry_Potter_Chapter1.pdf",
        "tulsi_gabbard": "../OneKE/data/input_files/Tulsi_Gabbard_News.html"
    }
}
